...
def check_inbox():
        ...
        for token_num in range(len(token_list)):
                ...
                a=r+t
                A+=a
                printsn(myname + ' - ' + str(t) + ' '+help("chx")[0] + ' - ' + str(r) + ' ' + help("chx")[1])
                if r<0: A-=r
                if not looping:
                        if a: printms()
                        else: printm='' #print()
